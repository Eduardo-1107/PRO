...
public class Comparativa {
    ...
    public void AñadirArticulo(string vend, string codigo, string producto, decimal precio) {
        //int i = 0;
    //    Articulo nuevoArticulo = new Articulo(vend, new Producto(codigo, producto), precio);
        Articulo nuevoArticulo = new Articulo(vend, codigo, producto, precio);
    ...
    public void GuardarCSV(string ruta) {
        ...
        //using(StreamWriter sw = new StreamWriter(new FileStream(ruta,FileMode.AppendText)))
